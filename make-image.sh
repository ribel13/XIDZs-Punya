...
modemmanager usb-modeswitch xmm-modem luci-proto-xmm"
...
# MISC PACKAGES
MISC+=" zoneinfo-core zoneinfo-asia jq htop httping adb openssh-sftp-server zram-swap screen \
atc-fib-l8x0_gl atc-fib-fm350_gl luci-proto-atc \
luci-app-lite-watchdog luci-app-ramfree luci-app-tinyfm luci-app-ttyd luci-app-mactodong"
